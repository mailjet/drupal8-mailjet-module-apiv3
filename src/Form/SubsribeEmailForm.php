    ...
    public function buildForm(array $form, FormStateInterface $form_state)
    {
        ...
        if (false != $response) {
            if (!empty($signup_form->success_message_subsribe)) {
                \Drupal::messenger()->addMessage(t($signup_form->success_message_subsribe), 'status', FALSE);
            } else {
                \Drupal::messenger()->addMessage(t('You have successfully subscribed to Mailjet contact list! Thank you!'), "status", FALSE);
            }
        }
